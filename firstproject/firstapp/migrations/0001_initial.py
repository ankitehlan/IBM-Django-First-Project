# Generated by Django 4.2.4 on 2023-10-22 16:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='firstapp.course')),
            ],
        ),
        migrations.CreateModel(
            name='Enrollment',
            fields=[
                ...
                ('learner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='firstapp.learner')),
            ],
        ),
        migrations.AddField(
            model_name='course',
            name='instructors',
            field=models.ManyToManyField(to='firstapp.instructor'),
        ),
        migrations.AddField(
            model_name='course',
            name='learner',
            field=models.ManyToManyField(through='firstapp.Enrollment', to='firstapp.learner'),
        ),
    ]
